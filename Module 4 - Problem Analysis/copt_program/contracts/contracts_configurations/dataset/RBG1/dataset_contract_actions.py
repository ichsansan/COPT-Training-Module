...
TAG_ASSOCIATIONS = {
    ...
    "Total Secondary Air Flow": {
        ...
        "OPC.AIRFLOW_2:HLACFB1.PNT": lambda x, scale_back=False: x * 2 if scale_back else x * 0.5,
        "OPC.AIRFLOW_2:HLACFB2.PNT": lambda x, scale_back=False: x * 2 if scale_back else x * 0.5
    },
    ...
    "Mill A Outlet Temperature": {
        "OPC.2JDAS:RT130501.PNT": None,
        "OPC.2PDAS:RT201701.PNT": None,
        "OPC.2PDAS:RT201801.PNT": None
    },
    "Mill B Outlet Temperature": {
        "OPC.2JDAS:RT130504.PNT": None,
        "OPC.2PDAS:RT201702.PNT": None,
        "OPC.2PDAS:RT201802.PNT": None
    },
    "Mill C Outlet Temperature": {
        "OPC.2KDAS:RT140501.PNT": None,
        "OPC.2PDAS:RT201703.PNT": None,
        "OPC.2PDAS:RT201803.PNT": None
    },
    "Mill D Outlet Temperature": {
        "OPC.2KDAS:RT140504.PNT": None,
        "OPC.2PDAS:RT201704.PNT": None,
        "OPC.2PDAS:RT201804.PNT": None
    },
    "Mill E Outlet Temperature": {
        "OPC.2LDAS:RT150501.PNT": None,
        "OPC.2PDAS:RT201705.PNT": None,
        "OPC.2PDAS:RT201805.PNT": None
    },

    "Windbox-to-Furnace Diff. Press A": {
        "OPC.2PDAS:PT201502.PNT": None,
        "OPC.2PDAS:PT201602.PNT": None
    },
    "Windbox-to-Furnace Diff. Press B": {
        "OPC.2PDAS:PT201504.PNT": None,
        "OPC.2PDAS:PT201604.PNT": None
    },

    "Cold Reheat Steam Pressure": {
        "OPC.2ODAS:PT193102.PNT": None,
        "OPC.2ODAS:PT193103.PNT": None
    },
    "Cold Reheat Steam Temperature": {
        "OPC.2ODAS:TE193406.PNT": None,
        "OPC.2ODAS:TE193407.PNT": None
    },
    ...
    "Main Steam Pressure": {"OPC.2ODAS:PT193101.PNT": None},
    "Main Steam Flow": {"OPC.MSTFLOW:CALCA2.RO01": None},

    "Hot Reheat Steam Pressure": {"OPC.2ODAS:PT193104.PNT": None},
    "Hot Reheat Steam Temperature": {"OPC.2ODAS:TE193503.PNT": None},

    "Coal Flow": {"OPC.FUELMASTER:AINCOAL.PNT": None},
    "Reheat Spray Temperature": {"OPC.2ODAS:TE193504.PNT": None},
    "Reheat Spray Water Pressure": {"OPC.2ODAS:PT193105.PNT": None},

    "Over-Fire-Air Dampers 1": {"OPC.2QDAS:ZT210205.PNT": None},
    "Over-Fire-Air Dampers 2": {"OPC.2QDAS:ZT210402.PNT": None},
    "Over-Fire-Air Dampers 3": {"OPC.2QDAS:ZT210507.PNT": None},
    "Over-Fire-Air Dampers 4": {"OPC.2QDAS:ZT210704.PNT": None},

    "Burner Tilt Position 1L": {"OPC.2QDAS:ZT210705.PNT": None},
    "Burner Tilt Position 1R": {"OPC.2QDAS:ZT210706.PNT": None},
    "Burner Tilt Position 2L": {"OPC.2QDAS:ZT210707.PNT": None},
    "Burner Tilt Position 2R": {"OPC.2QDAS:ZT210708.PNT": None},
    "Burner Tilt Position 3L": {"OPC.2QDAS:ZT210801.PNT": None},
    "Burner Tilt Position 3R": {"OPC.2QDAS:ZT210802.PNT": None},
    "Burner Tilt Position 4L": {"OPC.2QDAS:ZT210803.PNT": None},
    "Burner Tilt Position 4R": {"OPC.2QDAS:ZT210804.PNT": None},

    "SH Spray Water Pressure": {"OPC.2ODAS:PT193106.PNT": None},
    "SH Spray Temperature": {"OPC.2ODAS:TE193505.PNT": None},

    "Feed Water Pressure": {"OPC.2ODAS:PT193201.PNT": None},
    "Feed Water Temperature": {"OPC.2PDAS:TE202808.PNT": None},
