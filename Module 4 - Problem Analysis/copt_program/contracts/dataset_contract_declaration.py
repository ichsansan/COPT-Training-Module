...
TAG_TO_ASSOCIATION_KIND = {
    ...
    "Bed Pressure plus": DatasetTagAssociationKind.Single,
    "Bed Temperature": DatasetTagAssociationKind.MultipleAverage,
    "Bed Temperature plus": DatasetTagAssociationKind.Single,
    ...
    "Over-Fire-Air Dampers 1": DatasetTagAssociationKind.Single,
    "Over-Fire-Air Dampers 2": DatasetTagAssociationKind.Single,
    "Over-Fire-Air Dampers 3": DatasetTagAssociationKind.Single,
    "Over-Fire-Air Dampers 4": DatasetTagAssociationKind.Single,

    "Burner Tilt Position 1L": DatasetTagAssociationKind.Single,
    "Burner Tilt Position 1R": DatasetTagAssociationKind.Single,
    "Burner Tilt Position 2L": DatasetTagAssociationKind.Single,
    "Burner Tilt Position 2R": DatasetTagAssociationKind.Single,
    "Burner Tilt Position 3L": DatasetTagAssociationKind.Single,
    "Burner Tilt Position 3R": DatasetTagAssociationKind.Single,
    "Burner Tilt Position 4L": DatasetTagAssociationKind.Single,
    "Burner Tilt Position 4R": DatasetTagAssociationKind.Single,
    ...
    "FDF Fan Air Flow Calc": DatasetTagAssociationKind.Single
}
