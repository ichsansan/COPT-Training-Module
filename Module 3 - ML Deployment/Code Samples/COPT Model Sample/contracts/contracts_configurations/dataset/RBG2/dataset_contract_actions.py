...
TAG_ASSOCIATIONS = {
    ...
    "Burner Tilt Position 1L": {
        "OPC.1QDAS:ZT210705.PNT": None,
        "OPC.1QDAS:ZT210707.PNT": None,
        "OPC.1QDAS:ZT210801.PNT": None,
        "OPC.1QDAS:ZT210803.PNT": None
    },
    "Burner Tilt Position 1R": {
        "OPC.1QDAS:ZT210706.PNT": None,
        "OPC.1QDAS:ZT210708.PNT": None,
        "OPC.1QDAS:ZT210802.PNT": None,
        "OPC.1QDAS:ZT210804.PNT": None
    },
    ...
    "Total Secondary Air Flow plus Avg": {
        "OPC.1AW1002.1E_AIRFLOW.FURB1AIN.PNT": lambda x, scale_back=False: x * 2 if scale_back else x * 0.5,
        "OPC.1AW1002.1E_AIRFLOW.FURB2AIN.PNT": lambda x, scale_back=False: x * 2 if scale_back else x * 0.5,
    },
    ...
    "Total Secondary Air Flow": {
        "OPC.1AIRFLOW_1:HLACFA1.PNT": None,
        "OPC.1AIRFLOW_1:HLACFA2.PNT": None
    },

    "Total Secondary Air Flow plus": {
        "OPC.1AIRFLOW_2:HLACFB1.PNT": None,
        "OPC.1AIRFLOW_2:HLACFB2.PNT": None
    },

    "Main Steam Temperature": {
        "OPC.12PDAS:TE202806.PNT": None,
        "OPC.12PDAS:TE202807.PNT": None
    },
    ...
    "PA Heater Out Press": {"OPC.1AIRFLOW:MATH1.RO01": None},
    "Generator Gross Load": {"OPC.1SDAS:AI174108.PNT": None},
    "Excess Oxygen Sensor": {"OPC.1OXYGEN:SIGSEL1.OUT": None},
}
