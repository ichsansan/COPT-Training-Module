...
const Rule = () => {
  ...
  const {
    combustionRecommendationDetailRuleData,
    combustionRecommendationDetailRuleValue,
    combustionRecommendationDetailRuleLogic,
  ...
  const ruleData = combustionRecommendationDetailRuleData?.map((item) =>
    createRuleData(
      item.sequence,
      item.minTime,
      item.setValue,
            ...
            <div className="flex flex-col">
              ...
              {showRuleLogic && (
                <pre className="mt-12 ">
                  <code
                    style={{
                      color: combustionRecommendationDetailRuleValue
                        ? '#4CAF50'
                        : '#F44336',
                    }}
